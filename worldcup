...
--
-- Name: games fkeyopponent; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fkeyopponent FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);


--
-- Name: games fkeywinner; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fkeywinner FOREIGN KEY (winner_id) REFERENCES public.teams(team_id);
